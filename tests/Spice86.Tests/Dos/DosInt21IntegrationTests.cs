...
public class DosInt21IntegrationTests {
    ...
    public void InterruptVectors_For21_22_23_24_AreInstalled() {
        byte[] program = new byte[] {
            ...
            0xCD, 0x21,             // int 21h
            0x81, 0xFB, 0xF0, 0xFF, // cmp bx, 0FFF0h
            0x75, 0x0A,             // jne next_int24
            0x8C, 0xDA,             // mov dx, es
            0x81, 0xFA, 0x00, 0xF0, // cmp dx, 0F000h
            0x75, 0x02,             // jne next_int24
            0xEB, 0x19,             // jmp failed

            // next_int24:
            0xB8, 0x24, 0x35,       // mov ax, 3524h
            0xCD, 0x21,             // int 21h
            0x81, 0xFB, 0xF0, 0xFF, // cmp bx, 0FFF0h
            0x75, 0x0A,             // jne success
            0x8C, 0xDA,             // mov dx, es
            0x81, 0xFA, 0x00, 0xF0, // cmp dx, 0F000h
            0x75, 0x02,             // jne success
            0xEB, 0x04,             // jmp failed
