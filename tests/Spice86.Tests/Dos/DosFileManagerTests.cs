...
public class DosFileManagerTests {
    ...
    private static DosFileManager ArrangeDosFileManager(string mountPoint) {
        ...
        return new DosFileManager(new Memory(ram, configuration.A20Gate, configuration.InitializeDOS is true), configuration.CDrive, configuration.Exe, loggerServiceMock, dosDevicesMock);
    }
}
