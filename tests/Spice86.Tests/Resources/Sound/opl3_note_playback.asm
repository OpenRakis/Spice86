...
;   3. Key-on channel 0
;   4. Busy-waits for ~200ms to let the mixer capture audio
;   5. Uses Timer 1 to measure timing
;   6. Reports elapsed poll count
;
...
start:
    ...
    ; ========================================
    ; Step 3b: Busy-wait to let mixer capture audio
    ; ========================================
