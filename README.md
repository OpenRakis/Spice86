...
- Example: `--HttpApiPort 10001` starts the server at `http://127.0.0.1:10001`.
- Use `--HttpApiPort 0` (or omit it) to disable the server.
- The server runs independently from the UI once started.
