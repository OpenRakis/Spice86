...
Spice86 --help
  ...
  -s, --JumpFile                     (Default: spice86dumpSymbols.txt) Text file with labels and functions. Format is the format expected by ghidra. Provide it not to start from scrach every time.
```
