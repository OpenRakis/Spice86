...
- **Overall progress (effort-weighted, including Phase 2): 95%**.
- **Per-phase progression:**
  ...
  - Phase 1d: **100%**
  - Phase 1e: **100%**
  - Phase 2: **50%** (Atom A landed: VFAT LFN codec + paired directory reader with 14 tests; Atom B remaining: write integration + 8.3 alias generation)
