...
public sealed class Configuration {
    ...
    /// </summary>
    [Option(nameof(Cycles), Default = null, Required = false, HelpText = "Precise control of the number of emulated CPU cycles per ms. For the rare speed-sensitive game. Overrides instructions per second if used.")]
