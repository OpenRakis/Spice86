...
public sealed class Configuration {
    ...
    /// </summary>
    [Option('p', nameof(ProgramEntryPointSegment), Default = (ushort)0x80, Required = false, HelpText = "Segment where to load the program. DOS PSP and MCB will be created before it.")]
