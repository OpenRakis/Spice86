...
/// <summary>
/// Contains information about a file found by DOS.
/// <remarks>Online documentation name this structure a FILEINFO structure, but FileInfo is also a class in System.IO<br/>
/// In FreeDOS, this is called a dmatch.</remarks>
/// </summary>
public class FileMatch : MemoryBasedDataStructure {
    /// <summary>
    ...
    /// <inheritdoc/>
    public FileMatch(IByteReaderWriter byteReaderWriter, uint baseAddress) : base(byteReaderWriter, baseAddress) {
