...
public class DosMemoryControlBlock : MemoryBasedDataStructure {
    ...
    /// </remarks>
    public ushort AllocationSize { get => UInt16[SizeFieldOffset]; set => UInt16[SizeFieldOffset] = value; }

    public int AllocationSizeInBytes => AllocationSize * 16;

    /// <summary>
    /// Gets the usable space segment associated with the MCB.
    /// </summary>
    /// <remarks>
    /// Allocation starts here and extends for <see cref="AllocationSize"/> * 16 bytes.
    /// </remarks>
    ...
    public DosMemoryControlBlock? GetNextOrDefault() {
        uint baseAddress = BaseAddress + MemoryUtils.ToPhysicalAddress((ushort)(AllocationSize + 1), 0);
    ...
    public override string ToString() {
        return new StringBuilder("IsValid").Append(IsValid)
            ...
            .Append(" Size: ").Append(AllocationSize)
