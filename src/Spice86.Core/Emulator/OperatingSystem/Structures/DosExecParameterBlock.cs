...
public class DosExecParameterBlock : MemoryBasedDataStructure {
    ...
    /// <summary>
    /// Gets or sets the initial SP value for the child process (LoadOnly mode).
    /// </summary>
    /// <remarks>Offset 0x0E, 2 bytes. Only used when AL=01h.</remarks>
    public ushort InitialSP { get => UInt16[0x0E]; set => UInt16[0x0E] = value; }

    /// <summary>
    /// Gets or sets the initial SS value for the child process (LoadOnly mode).
    /// </summary>
    /// <remarks>Offset 0x10, 2 bytes. Only used when AL=01h.</remarks>
    public ushort InitialSS { get => UInt16[0x10]; set => UInt16[0x10] = value; }

    /// <summary>
    /// Gets or sets the initial IP value for the child process (LoadOnly mode).
    /// </summary>
    /// <remarks>Offset 0x12, 2 bytes. Only used when AL=01h.</remarks>
    public ushort InitialIP { get => UInt16[0x12]; set => UInt16[0x12] = value; }

    /// <summary>
    /// Gets or sets the initial CS value for the child process (LoadOnly mode).
    /// </summary>
    /// <remarks>Offset 0x14, 2 bytes. Only used when AL=01h.</remarks>
