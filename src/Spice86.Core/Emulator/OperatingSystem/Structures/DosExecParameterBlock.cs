...
/// </summary>
internal class DosExecParameterBlock : MemoryBasedDataStructure {
    ...
    /// <summary>
    /// Gets or sets the segment of the command line used to execute the program. Copied at the end of the child PSP.
    /// </summary>
    public ushort CommandTailSegment { get => UInt16[0x2]; set { UInt16[0x2] = value; } }

    public DosCommandTail CommandTail { get => new(ByteReaderWriter, MemoryUtils.ToPhysicalAddress(CommandTailSegment, 0)); }

    /// <summary>
    /// Gets or sets the address of the first file control block. Unopened FCB to be copied to the child PSP.
    /// </summary>
    public ushort FirstFileControlBlock { get => UInt16[0x4]; set { UInt16[0x4] = value; } }

    /// <summary>
    /// Gets or sets the address of the second file control block. Unopened FCB to be copied to the child PSP.
    /// </summary>
    public ushort SecondFileControlBlock { get => UInt16[0x6]; set { UInt16[0x6] = value; } }

    public ushort InitSsSp { get => UInt16[0x8]; set { UInt16[0x8] = value; } }

    public ushort InitCsIp { get => UInt16[0x10]; set { UInt16[0x10] = value; } }

    /// <summary>
    /// Gets or sets the load segment. This is where the new program will start execution.
    /// </summary>
    public ushort LoadSegment { get => UInt16[0x12]; set { UInt16[0x12] = value; } }
    ...
    /// </summary>
    public ushort RelocationSegment { get => UInt16[0x14]; set { UInt16[0x14] = value; } }
}
