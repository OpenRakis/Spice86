...
public class DosSysVars : MemoryBasedDataStructure {
    ...
    public ushort MagicWord {
        get => UInt16[OfficialOffset - 0x22];
        set => UInt16[OfficialOffset - 0x22] = value;
    }
    ...
    public ushort RegCXfrom5e {
        get => UInt16[OfficialOffset - 0x18];
        set => UInt16[OfficialOffset - 0x18] = value;
    }
    ...
    public ushort CountLRUCache {
        get => UInt16[OfficialOffset - 0x16];
        set => UInt16[OfficialOffset - 0x16] = value;
    }
    ...
    public ushort CountLRUOpens {
        get => UInt16[OfficialOffset - 0x14];
        set => UInt16[OfficialOffset - 0x14] = value;
    }
    ...
    public ushort SharingCount {
        get => UInt16[OfficialOffset - 0x0C];
        set => UInt16[OfficialOffset - 0x0C] = value;
    }
    ...
    public ushort SharingDelay {
        get => UInt16[OfficialOffset - 0x0A];
        set => UInt16[OfficialOffset - 0x0A] = value;
    }
    ...
    public ushort PtrCONInput {
        get => UInt16[OfficialOffset - 0x04];
        set => UInt16[OfficialOffset - 0x04] = value;
    }
    ...
    public ushort FirstMCB {
        get => UInt16[OfficialOffset - 0x02];
        set => UInt16[OfficialOffset - 0x02] = value;
    }
    ...
    public ushort MaxSectorLength {
        get => UInt16[OfficialOffset + 0x10];
        set => UInt16[OfficialOffset + 0x10] = value;
    }
    ...
    public ushort FcbKeepCount {
        get => UInt16[OfficialOffset + 0x1E];
        set => UInt16[OfficialOffset + 0x1E] = value;
    }
    ...
    public byte DiskParameterBlockCount {
        get => UInt8[OfficialOffset + 0x20];
        set => UInt8[OfficialOffset + 0x20] = value;
    }
    ...
    public byte CurrentDirectoryStructureCount {
        get => UInt8[OfficialOffset + 0x21];
        set => UInt8[OfficialOffset + 0x21] = value;
    }
    ...
    public byte JoinedDriveCount {
        get => UInt8[OfficialOffset + 0x34];
        set => UInt8[OfficialOffset + 0x34] = value;
    }
    ...
    public ushort SpecialCodeSegment {
        get => UInt16[OfficialOffset + 0x35];
        set => UInt16[OfficialOffset + 0x35] = value;
    }
    ...
    public ushort A20GateFixRoutineOffset {
        get => UInt16[OfficialOffset + 0x3B];
        set => UInt16[OfficialOffset + 0x3B] = value;
    }
    ...
    public ushort LastProgramPspSegment {
        get => UInt16[OfficialOffset + 0x3D];
        set => UInt16[OfficialOffset + 0x3D] = value;
    }
    ...
    public ushort NumberOfBuffers {
        get => UInt16[OfficialOffset + 0x3F];
        set => UInt16[OfficialOffset + 0x3F] = value;
    }
    ...
    public ushort NumberOfLookaheadBuffers {
        get => UInt16[OfficialOffset + 0x41];
        set => UInt16[OfficialOffset + 0x41] = value;
    }
    ...
    public byte BootDrive {
        get => UInt8[OfficialOffset + 0x43];
        set => UInt8[OfficialOffset + 0x43] = value;
    }
    ...
    public byte DwordMoveFlag386 {
        get => UInt8[OfficialOffset + 0x44];
        set => UInt8[OfficialOffset + 0x44] = value;
    }
    ...
    public ushort ExtendedMemorySize {
        get => UInt16[OfficialOffset + 0x45];
        set => UInt16[OfficialOffset + 0x45] = value;
    }
    ...
    public ushort DirtyDiskBuffers {
        get => UInt16[OfficialOffset + 0x4B];
        set => UInt16[OfficialOffset + 0x4B] = value;
    }
    ...
    public ushort LookaheadBufNumber {
        get => UInt16[OfficialOffset + 0x51];
        set => UInt16[OfficialOffset + 0x51] = value;
    }
    ...
    public byte BufferLocation {
        get => UInt8[OfficialOffset + 0x53];
        set => UInt8[OfficialOffset + 0x53] = value;
    }
    ...
    public byte ChainingUMB {
        get => UInt8[OfficialOffset + 0x63];
        set => UInt8[OfficialOffset + 0x63] = value;
    }
    ...
    public ushort MinMemForExec {
        get => UInt16[OfficialOffset + 0x64];
        set => UInt16[OfficialOffset + 0x64] = value;
    }
    ...
    public ushort StartOfUMBChain {
        get => UInt16[OfficialOffset + 0x66];
        set => UInt16[OfficialOffset + 0x66] = value;
    }
    ...
    public ushort MemAllocScanStart {
        get => UInt16[OfficialOffset + 0x68];
        set => UInt16[OfficialOffset + 0x68] = value;
    }
}
