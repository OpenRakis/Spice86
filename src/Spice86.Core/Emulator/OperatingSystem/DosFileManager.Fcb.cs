...
public partial class DosFileManager {
    ...
    public bool CloseFcb(ushort segment, ushort offset) {
        ...
        return CloseFileOrDevice(fhandle).IsError == false;
    }
    ...
    public byte ReadFcb(ushort segment, ushort offset, ushort recordNumber) {
        ...
        DosFileOperationResult readResult = ReadFileOrDevice(fhandle, recordSize, dtaAddress + (uint)(recordNumber * recordSize));
    ...
    public bool GetFileSizeFcb(ushort segment, ushort offset) {
        ...
        if (OpenFileOrDevice(shortname, FileAccessMode.ReadOnly).IsError) {
            return false;
        }
