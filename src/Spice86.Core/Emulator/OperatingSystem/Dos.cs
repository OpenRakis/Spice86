...
public sealed class Dos {
    ...
    public Dos(Configuration configuration, IMemory memory,
        ...
        FcbManager = new DosFcbManager(_memory, FileManager, DosDriveManager, _loggerService);

        ProcessManager = new(_memory, stack, state, pspTracker, MemoryManager, FileManager, DosDriveManager, FcbManager, envVars, _loggerService);
