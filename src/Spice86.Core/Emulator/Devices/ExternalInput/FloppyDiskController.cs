...
public sealed class FloppyDiskController : DefaultIOPortHandler {
    ...
    private readonly DualPic _interruptController;
    private readonly FloppyDiskTransferService _transferService;
    ...
    private void ExecuteSenseDriveStatus() {
        ...
        //   bit  4:   track 0 signal (asserted only when head is at cylinder 0)
        //   bit  5:   write protected (not set here — images are writable)
        //   bit  6:   ready (always set when drive is present)
        byte st3 = (byte)((driveSelect & 0x07) | 0x08 | 0x40);
    ...
    private void RaiseCompletionInterrupt() {
        _interruptController.ActivateIrq(6);
    }
