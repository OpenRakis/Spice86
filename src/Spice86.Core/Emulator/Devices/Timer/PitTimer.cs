...
public sealed class PitTimer : IDisposable, IPitControl, ITimeMultiplier {
    ...
    public PitTimer(IOPortHandlerRegistry ioPortHandlerRegistry, DualPic pic, IPitSpeaker pcSpeaker, DeviceScheduler scheduler, IEmulatedClock clock, ILoggerService logger) {
    ...
    private double PicFullIndex => _clock.CurrentTime;
