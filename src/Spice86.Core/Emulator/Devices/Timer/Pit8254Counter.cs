...
public class Pit8254Counter {
    ...
    /// <summary>
    /// Fires when the Frequency is changed.
    /// </summary>
    public event EventHandler? FrequencyChangedEvent;
    ...
    /// <br/>
    /// Looks like mode 3 is the mode games expect to find when they start
    /// </summary>
    ...
    /// </summary>
    public ushort CurrentCount { get => _currentCountRegister.Value; set => _reloadValueRegister.Value = value; }
    ...
    public void WriteReloadValueByt(byte value) {
    ...
    public void UpdateDesiredFrequency(long desiredFrequency) {
        ...
        FrequencyChangedEvent?.Invoke(this, EventArgs.Empty);
    }
