...
public class Renderer : IVgaRenderer {
    ...
    public Renderer(IMemory memory, IVideoState state, VgaBlinkState blinkState, Microsoft.Extensions.Logging.ILogger loggerService, IVgaRenderer256Color renderer256Color) {
        _state = state;
