...
/// <summary>
/// <see cref="IAstVisitor{T}"/> that renders an AST node to a plain string.
/// Delegates all traversal logic to <see cref="AstFormattedTokenRenderer"/> combined with a
...
public class AstInstructionRenderer : IAstVisitor<string> {
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="AstInstructionRenderer"/>.
    /// </summary>
