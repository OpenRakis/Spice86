...
/// </summary>
public readonly record struct FunctionCall(CallType CallType, SegmentedAddress EntryPointAddress, SegmentedAddress? ExpectedReturnAddress, SegmentedAddress StackAddressAfterCall, CallInstruction? Initiator) {
    /// <summary>
