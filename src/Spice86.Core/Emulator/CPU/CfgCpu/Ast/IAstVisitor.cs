...
public interface IAstVisitor<T> {
    public T VisitInstructionFieldNode(InstructionFieldNode node);
    ...
    public T VisitSegmentedAddressNode(SegmentedAddressNode node);
    ...
    public T VisitNearAddressNode(NearAddressNode node);
