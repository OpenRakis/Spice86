...
public class Cpuid : CfgInstruction {
    public Cpuid(SegmentedAddress address, InstructionField<ushort> opcodeField, List<InstructionPrefix> prefixes) :
