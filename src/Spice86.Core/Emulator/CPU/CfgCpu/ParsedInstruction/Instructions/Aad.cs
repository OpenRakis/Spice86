...
public class Aad : InstructionWithValueField<byte> {
    ...
    protected override IVisitableAstNode BuildExecutionAst(AstBuilder builder) {
        ...
        return builder.WithIpAdvancement(
            ...
            builder.Assign(DataType.BOOL, builder.Flag.Auxiliary(), new ConstantNode(DataType.BOOL, 0)),
            builder.Assign(DataType.BOOL, builder.Flag.Overflow(), new ConstantNode(DataType.BOOL, 0)));
    }
}