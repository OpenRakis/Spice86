...
public class MovRmReg16 : InstructionWithModRm {
    public MovRmReg16(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
