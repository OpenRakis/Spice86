...
public class Grp1SubUnsigned32 : Grp1<uint> {
    public Grp1SubUnsigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
