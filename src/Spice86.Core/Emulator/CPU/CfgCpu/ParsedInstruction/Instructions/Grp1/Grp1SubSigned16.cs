...
public class Grp1SubSigned16 : Grp1<sbyte> {
    public Grp1SubSigned16(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
