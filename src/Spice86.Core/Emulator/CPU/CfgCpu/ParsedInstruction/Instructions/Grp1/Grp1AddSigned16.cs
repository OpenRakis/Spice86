...
public class Grp1AddSigned16 : Grp1<sbyte> {
    public Grp1AddSigned16(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
