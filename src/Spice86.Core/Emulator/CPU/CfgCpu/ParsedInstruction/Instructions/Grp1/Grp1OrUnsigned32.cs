...
public class Grp1OrUnsigned32 : Grp1<uint> {
    public Grp1OrUnsigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
