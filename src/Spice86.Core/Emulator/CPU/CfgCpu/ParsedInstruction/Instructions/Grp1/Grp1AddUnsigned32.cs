...
public class Grp1AddUnsigned32 : Grp1<uint> {
    public Grp1AddUnsigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
