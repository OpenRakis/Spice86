...
public class Grp1OrUnsigned16 : Grp1<ushort> {
    public Grp1OrUnsigned16(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
