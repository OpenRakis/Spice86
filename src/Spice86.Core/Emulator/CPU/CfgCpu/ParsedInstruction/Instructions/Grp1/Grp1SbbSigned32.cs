...
public class Grp1SbbSigned32 : Grp1<sbyte> {
    public Grp1SbbSigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
