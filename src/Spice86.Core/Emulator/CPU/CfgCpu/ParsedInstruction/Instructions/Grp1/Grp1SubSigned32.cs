...
public class Grp1SubSigned32 : Grp1<sbyte> {
    public Grp1SubSigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
