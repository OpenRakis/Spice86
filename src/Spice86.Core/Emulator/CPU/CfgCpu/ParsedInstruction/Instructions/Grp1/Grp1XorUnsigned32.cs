...
public class Grp1XorUnsigned32 : Grp1<uint> {
    public Grp1XorUnsigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
