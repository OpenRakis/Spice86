...
public class Grp1AndUnsigned32 : Grp1<uint> {
    public Grp1AndUnsigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
