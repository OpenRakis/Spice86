...
public class Grp1XorSigned32 : Grp1<sbyte> {
    public Grp1XorSigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
