...
public class Grp1CmpSigned32 : Grp1<sbyte> {
    public Grp1CmpSigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
