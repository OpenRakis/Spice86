...
public class Grp1CmpUnsigned32 : Grp1<uint> {
    public Grp1CmpUnsigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
