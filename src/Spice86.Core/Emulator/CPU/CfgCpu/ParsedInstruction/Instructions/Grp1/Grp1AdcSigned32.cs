...
public class Grp1AdcSigned32 : Grp1<sbyte> {
    public Grp1AdcSigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
