...
public class Grp1AdcUnsigned16 : Grp1<ushort> {
    public Grp1AdcUnsigned16(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
