...
public class Grp1AndSigned32 : Grp1<sbyte> {
    public Grp1AndSigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
