...
public class Grp1SbbSigned16 : Grp1<sbyte> {
    public Grp1SbbSigned16(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
