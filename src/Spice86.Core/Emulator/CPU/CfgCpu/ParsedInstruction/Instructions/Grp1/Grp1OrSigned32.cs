...
public class Grp1OrSigned32 : Grp1<sbyte> {
    public Grp1OrSigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
