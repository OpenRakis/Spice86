...
public class Grp1AdcUnsigned32 : Grp1<uint> {
    public Grp1AdcUnsigned32(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
