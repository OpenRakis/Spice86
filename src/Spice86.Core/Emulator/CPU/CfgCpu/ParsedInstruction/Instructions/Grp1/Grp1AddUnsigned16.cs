...
public class Grp1AddUnsigned16 : Grp1<ushort> {
    public Grp1AddUnsigned16(SegmentedAddress address, InstructionField<byte> opcodeField, List<InstructionPrefix> prefixes,
