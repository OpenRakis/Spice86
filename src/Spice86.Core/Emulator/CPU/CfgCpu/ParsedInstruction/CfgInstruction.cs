...
public sealed class CfgInstruction : CfgNode {
    ...
    /// </summary>
    public IReadOnlyList<SegmentedAddress> StaticSuccessorAddresses => _staticSuccessorAddresses;

    private readonly List<SegmentedAddress> _staticSuccessorAddresses = new();
