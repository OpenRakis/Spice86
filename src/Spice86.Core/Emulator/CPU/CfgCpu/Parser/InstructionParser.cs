...
public class InstructionParser : BaseInstructionParser {
    ...
    private CfgInstruction ParseCfgInstruction(ParsingContext context) {
        switch (context.OpcodeField.Value) {
            ...
            case 0x06:
                return new PushSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.EsIndex);
            case 0x07:
                return new PopSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.EsIndex);
            case 0x08:
            case 0x09:
            case 0x0A:
            case 0x0B:
            ...
            case 0x0E:
                return new PushSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.CsIndex);
            case 0x0F:
            ...
            case 0x16:
                return new PushSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.SsIndex);
            case 0x17:
                return new PopSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.SsIndex);
            case 0x18:
            case 0x19:
            case 0x1A:
            case 0x1B:
            ...
            case 0x1E:
                return new PushSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.DsIndex);
            case 0x1F:
                return new PopSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.DsIndex);
            case 0x20:
            case 0x21:
            case 0x22:
            case 0x23:
            ...
            case 0x8E:
                return new MovSregRm16(context.Address, context.OpcodeField, context.Prefixes, _modRmParser.ParseNext(context));
            case 0x8F:
            ...
            case 0x9A:
                return new CallFarImm16(context.Address, context.OpcodeField, _instructionReader.SegmentedAddress.NextField(true));
            case 0x9B:
            ...
            case 0xC8:
                ...
                if (context.HasOperandSize32) {
                    return new Enter32(context.Address, context.OpcodeField, context.Prefixes, storageField, levelField);
                }
            ...
            case 0xE3:
                ...
                if (context.HasOperandSize32) {
                    return new Jcxz32(context.Address, context.OpcodeField, context.Prefixes, offsetField);
                }
                return new Jcxz16(context.Address, context.OpcodeField, context.Prefixes, offsetField);
            case 0xE4:
            case 0xE5:
            ...
            case 0xE9:
                ...
                return new JmpNearImm16(context.Address, context.OpcodeField, context.Prefixes,
                    _instructionReader.Int16.NextField(true));
            case 0xEA:
                return new JmpFarImm(context.Address, context.OpcodeField, _instructionReader.SegmentedAddress.NextField(true));
            case 0xEB:
                return new JmpNearImm8(context.Address, context.OpcodeField, context.Prefixes, _instructionReader.Int8.NextField(true));
            case 0xEC:
            case 0xED:
            ...
            case 0x0FA0:
                return new PushSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.FsIndex);
            case 0x0FA1:
                return new PopSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.FsIndex);
            case 0x0FA4:
                return _shldImm8RmParser.Parse(context);
            case 0x0FA5:
                return _shldClRmParser.Parse(context);
            case 0x0FA8:
                return new PushSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.GsIndex);
            case 0x0FA9:
                return new PopSReg(context.Address, context.OpcodeField, context.Prefixes, (int)SegmentRegisterIndex.GsIndex);
            case 0x0FB2:
