...
/// <summary>IN ACC, DX or OUT DX, ACC</summary>
public class IoAccDxParser : BaseInstructionParser {
    public IoAccDxParser(ParsingTools parsingTools) : base(parsingTools) {
    }
