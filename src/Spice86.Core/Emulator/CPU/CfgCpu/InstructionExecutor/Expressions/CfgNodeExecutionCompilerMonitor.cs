...
public class CfgNodeExecutionCompilerMonitor : IDisposable {
    ...
    private readonly CompilerState _currentState = new CompilerState();
    ...
    private sealed class CompilerState : IEquatable<CompilerState> {
        ...
        public bool Equals(CompilerState? other) {
            if (other is null) {
                return false;
            }
            ...
            return TotalInterpreted == other.TotalInterpreted
                && TotalSwapped == other.TotalSwapped
                && TotalSuccess == other.TotalSuccess
                && TotalFailures == other.TotalFailures;
        }

        public override bool Equals(object? obj) {
            return Equals(obj as CompilerState);
        }

        public override int GetHashCode() {
            return HashCode.Combine(TotalInterpreted, TotalSwapped, TotalSuccess, TotalFailures);
        }
    }
