...
///    Faults: These can be corrected and the program may continue as if nothing happened. <br/>
///    Traps: Traps are reported immediately after the execution of the trapping instruction. <br/>
