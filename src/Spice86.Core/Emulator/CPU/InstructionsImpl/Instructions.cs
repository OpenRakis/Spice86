...
public abstract class Instructions {
    ...
    protected readonly StaticAddressesRecorder StaticAddressesRecorder;
    ...
    protected uint DsNextUint16Address => ModRM.GetAddress(SegmentRegisters.DsIndex, Cpu.NextUint16(), true);

    public Instructions(Machine machine, Alu alu, Cpu cpu, Memory.Memory memory, ModRM modRm, StaticAddressesRecorder staticAddressesRecorder) {
        Machine = machine;
        Alu = alu;
        Cpu = cpu;
        State = cpu.State;
