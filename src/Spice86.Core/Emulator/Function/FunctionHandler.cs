...
public class FunctionHandler {
    ...
    public void Ret(CallType returnCallType, IRetInstruction? ret) {
        ...
        bool returnAddressAlignedWithCallStack = AddReturn(returnCallType, currentFunctionCall);
        ...
        if (_loggerService.IsEnabled(LogEventLevel.Verbose)) {
            ...
            _loggerService.Verbose("Returning from {From} to {To}", currentFunctionInformation, _functionCatalogue.GetFunctionInformation(CurrentFunctionCall));
        }
    }
    ...
    private bool AddReturn(CallType returnCallType, FunctionCall currentFunctionCall) {
        ...
        bool returnAddressAlignedWithCallStack = DetectUnalignedReturns(currentFunctionCall, actualReturnAddress, currentFunctionReturn);
        FunctionInformation? currentFunctionInformation = _functionCatalogue.GetFunctionInformation(currentFunctionCall);
    ...
    private bool DetectUnalignedReturns(FunctionCall currentFunctionCall, SegmentedAddress? actualReturnAddress, FunctionReturn currentFunctionReturn) {
