...
public sealed class Bios {
    ...
    public byte DiskMotorTimer {
        get => _memory.UInt8[0x0040, 0x0040];
        set => _memory.UInt8[0x0040, 0x0040] = value;
    }
    ...
    public byte VideoMode {
        get => _memory.UInt8[0x0040, 0x0049];
        set => _memory.UInt8[0x0040, 0x0049] = value;
    }
    ...
    public byte ScreenColumns {
        get => _memory.UInt8[0x0040, 0x004A];
        set => _memory.UInt8[0x0040, 0x004A] = value;
    }
    ...
    public ushort CrtControllerBaseAddress {
        get => _memory.UInt16[0x0040, 0x0063];
        set => _memory.UInt16[0x0040, 0x0063] = value;
    }
    ...
    public uint RealTimeClock {
        get => _memory.UInt32[0x0040, 0x006C];
        set => _memory.UInt32[0x0040, 0x006C] = value;
    }
    ...
    public byte ScreenRows {
        get => _memory.UInt8[0x0040, 0x0084];
        set => _memory.UInt8[0x0040, 0x0084] = value;
    }
    ...
    public ushort CharacterPointHeight {
        get => _memory.UInt16[0x0040, 0x0085];
        set => _memory.UInt16[0x0040, 0x0085] = value;
    }
    ...
    public byte VideoModeOptions {
        get => _memory.UInt8[0x0040, 0x0087];
        set => _memory.UInt8[0x0040, 0x0087] = value;
    }
    ...
    public byte FeatureSwitches {
        get => _memory.UInt8[0x0040, 0x0088];
        set => _memory.UInt8[0x0040, 0x0088] = value;
    }
    ...
    public byte VideoDisplayData {
        get => _memory.UInt8[0x0040, 0x0089];
        set => _memory.UInt8[0x0040, 0x0089] = value;
    }
}