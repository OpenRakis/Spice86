...
public abstract class IndexBasedDispatcher<T> where T: IRunnable {
    ...
    /// <summary>
    /// Extract the list of runnable items registered
    /// </summary>
    /// <returns>A list of all the runnables registered</returns>
    public IEnumerable<T> GetAllRunnables() {
        return _dispatchTable.Values;
    }
