...
public struct RegisterValueSet {
    ...
    internal static readonly VideoMode[] VgaModes = {
        new(0x00, new VgaMode(MemoryModel.Text, 40, 25, 4, 9, 16, VgaBios.ColorTextSegment), 0xFF, Palettes.Ega, SequencerRegisterValueSet1, 0x67, CrtControllerRegisterValueSet1, AttributeControllerRegisterValueSet1, GraphicsControllerRegisterValueSet1),
        new(0x01, new VgaMode(MemoryModel.Text, 40, 25, 4, 9, 16, VgaBios.ColorTextSegment), 0xFF, Palettes.Ega, SequencerRegisterValueSet1, 0x67, CrtControllerRegisterValueSet1, AttributeControllerRegisterValueSet1, GraphicsControllerRegisterValueSet1),
        new(0x02, new VgaMode(MemoryModel.Text, 80, 25, 4, 9, 16, VgaBios.ColorTextSegment), 0xFF, Palettes.Ega, SequencerRegisterValueSet2, 0x67, CrtControllerRegisterValueSet2, AttributeControllerRegisterValueSet1, GraphicsControllerRegisterValueSet1),
        new(0x03, new VgaMode(MemoryModel.Text, 80, 25, 4, 9, 16, VgaBios.ColorTextSegment), 0xFF, Palettes.Ega, SequencerRegisterValueSet2, 0x67, CrtControllerRegisterValueSet2, AttributeControllerRegisterValueSet1, GraphicsControllerRegisterValueSet1),
        new(0x04, new VgaMode(MemoryModel.Cga, 320, 200, 2, 8, 8, VgaBios.ColorTextSegment), 0xFF, Palettes.Cga, SequencerRegisterValueSet3, 0x63, CrtControllerRegisterValueSet3, AttributeControllerRegisterValueSet2, GraphicsControllerRegisterValueSet2),
        new(0x05, new VgaMode(MemoryModel.Cga, 320, 200, 2, 8, 8, VgaBios.ColorTextSegment), 0xFF, Palettes.Cga, SequencerRegisterValueSet3, 0x63, CrtControllerRegisterValueSet3, AttributeControllerRegisterValueSet2, GraphicsControllerRegisterValueSet2),
        new(0x06, new VgaMode(MemoryModel.Cga, 640, 200, 1, 8, 8, VgaBios.ColorTextSegment), 0xFF, Palettes.Cga, SequencerRegisterValueSet4, 0x63, CrtControllerRegisterValueSet4, AttributeControllerRegisterValueSet3, GraphicsControllerRegisterValueSet3),
        new(0x07, new VgaMode(MemoryModel.Text, 80, 25, 4, 9, 16, VgaBios.MonochromeTextSegment), 0xFF, Palettes.Monochrome, SequencerRegisterValueSet2, 0x66, CrtControllerRegisterValueSet5, AttributeControllerRegisterValueSet4, GraphicsControllerRegisterValueSet4),
        new(0x0D, new VgaMode(MemoryModel.Planar, 320, 200, 4, 8, 8, VgaBios.GraphicsSegment), 0xFF, Palettes.Cga, SequencerRegisterValueSet5, 0x63, CrtControllerRegisterValueSet6, AttributeControllerRegisterValueSet5, GraphicsControllerRegisterValueSet5),
        new(0x0E, new VgaMode(MemoryModel.Planar, 640, 200, 4, 8, 8, VgaBios.GraphicsSegment), 0xFF, Palettes.Cga, SequencerRegisterValueSet6, 0x63, CrtControllerRegisterValueSet7, AttributeControllerRegisterValueSet5, GraphicsControllerRegisterValueSet5),
        new(0x0F, new VgaMode(MemoryModel.Planar, 640, 350, 1, 8, 14, VgaBios.GraphicsSegment), 0xFF, Palettes.Monochrome, SequencerRegisterValueSet6, 0xa3, CrtControllerRegisterValueSet8, AttributeControllerRegisterValueSet6, GraphicsControllerRegisterValueSet5),
        new(0x10, new VgaMode(MemoryModel.Planar, 640, 350, 4, 8, 14, VgaBios.GraphicsSegment), 0xFF, Palettes.Ega, SequencerRegisterValueSet6, 0xa3, CrtControllerRegisterValueSet8, AttributeControllerRegisterValueSet7, GraphicsControllerRegisterValueSet5),
        new(0x11, new VgaMode(MemoryModel.Planar, 640, 480, 1, 8, 16, VgaBios.GraphicsSegment), 0xFF, Palettes.Ega, SequencerRegisterValueSet6, 0xe3, CrtControllerRegisterValueSet9, AttributeControllerRegisterValueSet8, GraphicsControllerRegisterValueSet5),
        new(0x12, new VgaMode(MemoryModel.Planar, 640, 480, 4, 8, 16, VgaBios.GraphicsSegment), 0xFF, Palettes.Ega, SequencerRegisterValueSet6, 0xe3, CrtControllerRegisterValueSet9, AttributeControllerRegisterValueSet7, GraphicsControllerRegisterValueSet5),
        new(0x13, new VgaMode(MemoryModel.Packed, 320, 200, 8, 8, 8, VgaBios.GraphicsSegment), 0xFF, Palettes.Vga, SequencerRegisterValueSet7, 0x63, CrtControllerRegisterValueSet10, AttributeControllerRegisterValueSet9, GraphicsControllerRegisterValueSet6),
        new(0x6A, new VgaMode(MemoryModel.Planar, 800, 600, 4, 8, 16, VgaBios.GraphicsSegment), 0xFF, Palettes.Ega, SequencerRegisterValueSet6, 0xe3, CrtControllerRegisterValueSet11, AttributeControllerRegisterValueSet7, GraphicsControllerRegisterValueSet5)
    };
}