...
public sealed class ExpandedMemoryManager : InterruptHandler, IVirtualDevice {
    ...
    public ExpandedMemoryManager(IMemory memory, IFunctionHandlerProvider functionHandlerProvider, Stack stack, State state, Microsoft.Extensions.Logging.ILogger loggerService)
