...
//        var newMountedFolder = new MountedFolder(currentDriveLetter, MountPoint) {
//            CurrentDirectory = MountPoint
//        };
//        dosPathResolver.DriveMap.Add(currentDriveLetter, newMountedFolder);
