                ...
                if (ActualDetailsTemplate != null && ActualDetailsTemplate != _appliedDetailsTemplate)
                {
                    ...
                    if (_detailsContent != null)
                    {
                        if (_detailsContent is Layout.Layoutable layoutableContent)
                        {
                            ...
                            _detailsContentSizeSubscription = ObservableCompatibilityHelper.Combine(
                                ObservableCompatibilityHelper.Create(() => layoutableContent.LayoutUpdated -= DetailsContent_LayoutUpdated),
                                ObservableCompatibilityHelper.Subscribe(_detailsContent.GetObservable(MarginProperty), margin => DetailsContent_MarginChanged(margin)));
