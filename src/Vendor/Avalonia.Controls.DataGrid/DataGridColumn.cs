    ...
    abstract class DataGridColumn : AvaloniaObject
    {
        ...
        internal void ComputeLayoutRoundedWidth(double leftEdge)
        {
            if (OwningGrid != null && OwningGrid.UseLayoutRounding)
            {
                ...
                var roundSize = LayoutHelperCompatibility.RoundLayoutSizeUp(new Size(leftEdge + ActualWidth, 1), scale);
        ...
        internal string GetSortPropertyName()
        {
            ...
            if (String.IsNullOrEmpty(result))
            {
                ...
                {
                    result = BindingCompatibilityHelper.GetPath(boundColumn.Binding);
                }
            }
