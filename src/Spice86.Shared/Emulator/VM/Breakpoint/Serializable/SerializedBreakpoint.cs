...
{
    /// <summary>
    /// Gets the format version of the serialized breakpoint.
    /// </summary>
    public int Version { get; init; } = 1;

    /// <summary>
    /// Gets or sets the trigger value for the breakpoint.
    /// </summary>
    public long Trigger { get; init; }
    
    /// <summary>
    /// Gets or sets the type of the breakpoint.
    /// </summary>
    public BreakPointType Type { get; init; }
    
    /// <summary>
    /// Gets or sets a value indicating whether the breakpoint should be removed after being triggered.
    /// </summary>
    public bool IsRemovedOnTrigger { get; init; }
    
    /// <summary>
    /// Gets or sets the comment for the breakpoint.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a condition expression for the breakpoint.
    /// When null or empty, the breakpoint is unconditional.
    /// </summary>
    /// <remarks>
