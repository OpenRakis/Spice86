namespace Spice86.Behaviors {
    ...
    public static class HighlightBehavior {
        ...
        #region TextBlock Highlighting

        public static readonly AttachedProperty<bool> IsHighlightedProperty = 
            AvaloniaProperty.RegisterAttached<TextBlock, bool>("IsHighlighted", typeof(HighlightBehavior), defaultValue: false);
        ...
        private static void OnIsHighlightedChanged(AvaloniaPropertyChangedEventArgs<bool> e) {
            if (e.Sender is TextBlock textBlock) {
                ...
                if (e.NewValue.Value) {
                    ...
                    Animation backgroundAnimation = CreateAnimation(TextBlock.BackgroundProperty, HighlightingConverter.GetHighlightBackgroundBrush(),
        ...
        #region ContentControl Highlighting
        ...
        #region Panel Highlighting

        public static readonly AttachedProperty<bool> IsPanelHighlightedProperty = 
            AvaloniaProperty.RegisterAttached<Panel, bool>("IsPanelHighlighted", typeof(HighlightBehavior), defaultValue: false);
        ...
        private static void OnIsPanelHighlightedChanged(AvaloniaPropertyChangedEventArgs<bool> e) {
            if (e.Sender is Panel panel) {
                if (e.NewValue.Value) {
                    ...
                    // Create animation for background fade-out
                    Animation backgroundAnimation = CreateAnimation(Panel.BackgroundProperty, HighlightingConverter.GetHighlightBackgroundBrush(),
                        HighlightingConverter.GetDefaultBackgroundBrush());
