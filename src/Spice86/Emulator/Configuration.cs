...
public class Configuration {
    ...
    [Option('j', nameof(JumpFile), Default = "spice86dumpExecutionFlow.json", Required = false, HelpText = "Json file generated by spice86 with records of addresses of jumps, calls, returns and information about self modifying code. Provide it not to start from scrach every time.")]
    public string? JumpFile { get; init; }
    [Option('s', nameof(SymbolsFile), Default = "spice86dumpSymbols.txt", Required = false, HelpText = "Text file with labels and functions. Format is the format expected by ghidra. Provide it not to start from scrach every time.")]
