...
public class Configuration {
    ...
    [Option('f', nameof(JumpFile), Default = "spice86dumpExecutionFlow.json", Required = false, HelpText = "Json file generated by spice86 with records of addresses of jumps, calls, returns and information about self modifying code. Provide it not to start from scrach every time.")]
