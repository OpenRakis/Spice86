...
public class Configuration {
    ...
    [Option('s', nameof(JumpFile), Default = "symbols.txt", Required = false, HelpText = "Text file with labels and functions. Format is the format expected by ghidra. Provide it not to start from scrach every time.")]
