    ...
    internal Spice86DependencyInjection(Configuration configuration, MainWindow? mainWindow) {
        ...
        if (mainWindowViewModel != null) {
            ...
            if (hostStorageProvider != null) {
                ViewModels.DrivesMenuViewModel drivesMenuViewModel = new ViewModels.DrivesMenuViewModel(dos, dos, dos, hostStorageProvider, new NullDriveEventNotifier(), driveActivityNotifier, dos, dos);
