...
/// Provides shared properties and methods for creating and validating memory breakpoints.
/// </summary>
public abstract partial class ViewModelWithMemoryBreakpoints : ViewModelBase {
    protected readonly State _state;
    protected readonly IMemory _memory;

    /// <summary>
    /// Initializes a new instance of the <see cref="ViewModelWithMemoryBreakpoints"/> class.
    /// </summary>
    ...
    protected ViewModelWithMemoryBreakpoints(State state, IMemory memory) {
        _state = state;
        _memory = memory;
    }
