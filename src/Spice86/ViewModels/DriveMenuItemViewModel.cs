...
public sealed partial class DriveMenuItemViewModel : ObservableObject {
    ...
    /// <summary>Gets the command that opens the disk info window for this drive.</summary>
    public IRelayCommand ShowDriveInfoCommand { get; }
    ...
    /// <summary>Gets the full host path of the currently active image or mounted folder.</summary>
