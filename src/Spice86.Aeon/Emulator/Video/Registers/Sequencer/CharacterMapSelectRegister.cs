...
/// the foreground intensity. This bit can be redefined as a switch between character sets, allowing 512 displayable characters. To
/// enable this feature:
...
public class CharacterMapSelectRegister : VgaRegisterBase {
    ...
    /// <summary>
    /// Map B is the area of plane 2 containing the character font table used to generate characters when attribute bit 3 is set to 0.
    /// </summary>
