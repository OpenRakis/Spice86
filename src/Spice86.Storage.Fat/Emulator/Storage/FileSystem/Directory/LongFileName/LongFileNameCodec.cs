...
public sealed class LongFileNameCodec
{
    ...
    public byte ComputeShortNameChecksum(ReadOnlySpan<byte> shortName11)
    {
    ...
    public IReadOnlyList<VfatLfnEntry> EncodeLongName(string longName, byte shortNameChecksum)
    {
    ...
    public void WriteSlot(VfatLfnEntry slot, Span<byte> destination)
    {
    ...
    public VfatLfnEntry? TryParseSlot(ReadOnlySpan<byte> entryBytes)
    {
    ...
    public string? DecodeLongName(IReadOnlyList<VfatLfnEntry> slotsInDiscOrder, byte expectedChecksum)
    {
