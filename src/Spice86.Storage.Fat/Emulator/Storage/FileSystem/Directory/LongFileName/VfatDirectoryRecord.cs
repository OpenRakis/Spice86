...
public sealed class VfatDirectoryRecord
{
    ...
    /// <summary>
    /// Gets the long file name reconstructed from preceding LFN slots, or
    /// null when no valid LFN chain precedes the short entry.
    /// </summary>
    public string? LongName { get; }

    /// <summary>Initialises a new <see cref="VfatDirectoryRecord"/>.</summary>
    /// <param name="shortEntry">The 8.3 short entry.</param>
    /// <param name="longName">The decoded long name, or null when absent.</param>
